...
let thumbwiz = fs.readFileSync('./Library/Bino.jpg')
//message type
/* let drips = fs.readFileSync('./Library/Bino.jpg')
*/
...
const reply = (teks) => {
    Wizard.sendMessage(m.chat, {text: teks, contextInfo: {"externalAdReply": {title: botname,mediaType: 3, renderLargerThumbnail: false, showAdAttribution: true, detectLinks: true,body: caption, thumbnail: thumbwiz,sourceUrl: ("github.com/Rosestorycity")}}})
}
const replay = (teks) => {
    Wizard.sendMessage(m.chat, {text: teks, contextInfo: {"externalAdReply": {title: botname,mediaType: 3, renderLargerThumbnail: false, showAdAttribution: true, body: caption, thumbnail: thumbwiz,sourceUrl: ("github.com/Rosestorycity")}}})
}
...
body: caption,
mediaType: "VIDEO",
mediaUrl: `https://github.com/Rosestorycity/Rose-Bot`,
...
displayText: 'MINE️'
    ...
    let buttonMessage = {
 image: { url: './Library/storage/image/Rose.jpg' },
 caption: caption,
 footer: pushname,
 buttons: buttons,
 headerType: 4
...
if (q.includes('--help')) return reply(examkosong) 
 ...
 if (lokasinya === 'Jungle') {
    var image = './Library/storage/image/Rose.jpg'
   } else
...
Please @${m.mentionedJid[0].split`@`[0]} to type accept/reject`
 ...
 case 'sc': case 'script': case 'donate': case 'donasi': case 'donate': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
  ...
  teks = `
  *${global.botname}*\n\n*TUTORIAL:* github.com/Rosestorycity\n*GITHUB:* https://github.com/Rosestorycity/Rose-Bot\n\n*INSTAGRAM:* https://instagram.com/rose_storycity\n\n You Can Support Us By Following Us On Social Media😊`
  let buttons = [
 {buttonId: `menu`, buttonText: {displayText: 'MENU <3'}, type: 1}
  ...
  thumbnail: thumbwiz,
  mediaType:1,
  mediaUrl: 'http://github.com/Rosestorycity',
  sourceUrl: "http://github.com/Rosestorycity"
  }}
  }
  Wizard.sendMessage(m.chat, buttonMessage, { quoted: m })
  }
...
case 'fd' : {         
   ...
   if (!text) throw 'Jid?' 
Wizard.sendMessage(text, {audio: media, mimetype: 'audio/mpeg', ptt: true, contextInfo: {externalAdReply : {title : `𝗦𝗣𝗔𝗥𝗞𝗬 𝗠𝗢𝗗𝗦 😌👑`, renderLargerThumbnail:false, showAdAttribution: true, body: `9:07●━━━━━━── 10:49⇆`, mediaUrl: `https://instagram.com/rose_storycity`, mediaType: 2, thumbnail: fs.readFileSync('./Library/Rose.jpg') }}}) 
...
case '🐦🐦' : {         
		...
		let media = await q.download()
   if (!text) throw 'Jid?' 
Wizard.sendMessage(text, {audio: media, contextInfo: {externalAdReply : {title : `ʀ ᴏ ꜱ ᴇ`, renderLargerThumbnail:false, showAdAttribution: true, body: `🦋❤️🦋`, mediaUrl: `https://instagram.com/rose_storycity`, mediaType: 2, thumbnail: fs.readFileSync('./Rose.jpg') }}}) 
    	} else throw 'Reply audio/video!'
       }
       break
...
break
 case 'tagall': case 'tag': {
   ...
   if (!isBotAdmins) throw mess.botAdmin
   if (!isAdmins) throw mess.admin
let teks = `╭╼━━━᚜ 𝗕𝗜𝗡𝗢-𝗠𝗗 ᚛━━╾ᐧᐧᐧᐧ⳹
│                                                 
│             *༺ 𝖳𝖠𝖦𝖠𝖫𝖫 ༻*
│
😘 𝗚𝗿𝗼𝘂𝗽 𝗻𝗮𝗺𝗲 : ${groupName}
│
🍓 𝗠𝗲𝘀𝘀𝗮𝗴𝗲 : 𝐈 𝐋𝐨𝐯𝐞 𝐓𝐡𝐢𝐬 𝐁𝐨𝐭 🤍
│
🗞️ 𝗔𝗻𝗻𝗼𝘂𝗻𝗰𝗲𝗿 : @⁨${pushname}
╰╼━━━━━━━━━━━━━━━╾ᐧᐧᐧᐧ⳹\n\n`
...
break
 ...
 urlButton: {
  displayText: 'SCRIPT',
  url: 'https://github.com/Rosestorycity/Rose-Bot'
 }
  }]
 fatihgans = thumbwiz
...
break
  ...
  Wizard.sendMessage(`917012984396@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
Report Message: ${text}` })
 ...
 *_${global.caption}_*` 
    ...
    const buttonsDefault = [{ urlButton: { displayText: `SUBSCRIBE`, url : `https://youtube.com/@lightdarkedits1072` } }, { urlButton: { displayText: `GITHUB`, url : `https://github.com/Rosestorycity/Rose-Bot` } },
    {					
      quickReplyButton: {
      displayText: 'SPEED',
      id: 'ping'
...
`,
    ...
    sections
      ...
      var buffer = await getBuffer(ppuser)
      let buttons = [
        {buttonId: `sc`, buttonText: {displayText: '𝗦𝗢𝗨𝗥𝗖𝗘 𝗖𝗢𝗗𝗘'}, type: 1},
        {buttonId: `owner`, buttonText: {displayText: '𝗢𝗪𝗡𝗘𝗥'}, type: 1},
        {buttonId: `rpgmenu`, buttonText: {displayText: '𝗥𝗣𝗚'}, type: 1},
        ]
        let buttonMessage = {
        document: fs.readFileSync('./Launcher/lib/tes.xlsx'),
        mimetype: dripsee,
...
"urlButton": {
"displayText": "SUBSCRIBE",
"url": "https://youtube.com/@lightdarkedits1072"
}
}, {
urlButton: {
displayText: 'GITHUB',
...
"urlButton": {
"displayText": "SUBSCRIBE",
"url": "https://youtube.com/@sparkymon777"
}
}, {
urlButton: {
displayText: 'GITHUB',
url: 'https://github.com/Sparkymon777/Bino-MD'
}
}
]
}
